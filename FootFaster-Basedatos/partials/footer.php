...
<div id="pie-pag">
    ...
    <center>
    <span>
      <button type="button-titured" class="btn-titured cube-titured cube-hover-titured">
        <div class="bg-top-titured">
        <div class="bg-inner-titured"></div>
        </div>
        <div class="bg-right-titured">
        <div class="bg-inner-titured"></div>
        </div>
        <div class="bg-titured">
        <div class="bg-inner-titured"></div>
        </div>
        <div class="text-titured">REDES SOCIALES</div>
      </button>
    </span>
    </center>
    ...
    <ul class="social">
      ...
      <li class="social-item">
        <a class="social-link" href="/">
          ...
          <span class="tooltip2">@Google</span>
        </a>
      </li>
      <li class="social-item">
        <a class="social-link" href="/">
          ...
          <span class="tooltip3">@Instagram</span>
        </a>
      </li>
      ...
      <li class="sos">
        <div class="ayuda">
          ...
          <button id="modal_btn2">
              <img src="/IMG/Inicio/signo.png" width="20px" height="20px">
              <p class="texto">¿TE AYUDAMOS?</p>
          </button>
...
<!-- Script index parte de la muestra de productos -->
